...
//           {item.name}
//         </Accordion.Header>
//         <Accordion.Body onClick={() => deleteCartItem(index)} eventKey={1 + index}>
//           $ {item.cost} from {item.country}
//         </Accordion.Body>
//       </Accordion.Item>
//     );
...
//       return { name, country, cost, instock };
//     });
//     setItems([...items, ...newItems]); // Append new items to existing items
//   };
      ...
      <Row>
        <form
          onSubmit={(event) => {
            ...
            console.log(`Restock called oooon ${query}`);
            event.preventDefault();
          }}
        >
          <input
